...
manpages:
	...
	install -D man/gcy-kms.1 $(DESTDIR)$(share)/man/man5/gcy-kms.5
	install -D man/gcy-gpg.1 $(DESTDIR)$(share)/man/man5/gcy-gpg.5
	install -D man/gcy-password.1 $(DESTDIR)$(share)/man/man5/gcy-password.5
